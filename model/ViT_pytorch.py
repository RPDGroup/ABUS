...
def get_ml_config(params):
    ...
    config.swin_depths = params['swin_depths']
    config.swin_num_heads = params['swin_num_heads']
    config.drop_path_rate = params['drop_path_rate']
    config.shift_size = params['shift_size']
    config.use_relative_position_bias = params['use_relative_position_bias']
    return config
...
class Encoder(nn.Module):
    ...
    def forward(self, hidden_states):
        # hidden_states: [batch_size, hidden_size * 6]]
        attn_weights = []
